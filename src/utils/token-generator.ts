...
import { TOKEN, CODE_GENERATION } from '../constants/app.constants';
 ...
 */
export function generateToken(length: number = TOKEN.DEFAULT_LENGTH): string {
...
export function generateRandomCode(length: number = 6): string {
    ...
    const chars = CODE_GENERATION.READABLE_CHARS;
    let result = '';
